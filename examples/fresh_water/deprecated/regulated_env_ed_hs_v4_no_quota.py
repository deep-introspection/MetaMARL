...
class WaterRegulatedEdHsEnv(MultiAgentRegulatedEnv):
    ...
    def _allowed_m3_day(self, reservoir_level_norm: float) -> float:
        ...
        # )
        return self.full_required_m3_day
    ...
    def violation_signal(
        ...
        *,
        ...
        self._update_infos(key="quota_stress", values={agent_id: 1.0})
        self._update_infos(key="min_demand_frac", values={agent_id: 1.0})
        self._update_infos(key="max_demand_frac", values={agent_id: 1.0})
    ...
    def transition_kernel(
        ...
        *,
        ...
        for agent_id, action in A_t.items():
            ...
            allowed_m3_day = self.full_required_m3_day
