...
from ray import init as ray_init, shutdown as ray_shutdown
...
def build_ppo_algorithm(
    ...
    config = (
        ...
        .multi_agent(
            policies={
                "fisher_policy": (None, observation_space, action_space, {})
            },
...
def train_algorithm(
    ...
    for iteration in range(num_iterations):
        ...
        if wandb_run is not None:
            ...
            episode_reward = result.get("env_runners", {}).get("episode_reward_mean", float("nan"))
            wandb_run.log({
